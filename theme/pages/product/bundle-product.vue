                      ...
                      <div class="border-product">
                            ...
                            <div class="bundle">
                                <div class="bundle_img">
                                    <div class="img-box">
                                        <a href="#"><img :src='"@/assets/images/fashion/pro/001.jpg"' alt="Bundle Product" class="img-fluid"></a>
                                    </div>
                                    <span class="plus">+</span>
                                    <div class="img-box">
                                        <a href="#"><img :src='"@/assets/images/fashion/pro/skirt.jpg"' alt="Bundle Product" class="img-fluid"></a>
                                    </div>
                                    <span class="plus">+</span>
                                    <div class="img-box">
                                        <a href="#"><img :src='"@/assets/images/fashion/pro/shoes.jpg"' alt="Bundle Product" class="img-fluid"></a>
                                    </div>
                                </div>
