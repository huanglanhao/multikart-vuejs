                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 rtl-text">
                    <div class="product-right">
                      ...
                      <h3 v-if="getDetail.sale">{{ discountedPrice(getDetail) * curr.curr | currency(curr.symbol) }}
                      </h3>
                      ...
                      <div class="product-buttons">
                        <nuxt-link :to="{ path: '/page/account/cart'}">
                          <button class="btn btn-solid" title="Add to cart" @click="addToCart(getDetail, counter)"
                            :disabled="counter > getDetail.stock">加入购物次</button>
                        </nuxt-link>
                        <button class="btn btn-solid" title="buy now" @click="buyNow(getDetail, counter)"
                          :disabled="counter > getDetail.stock">立即购买</button>
                      </div>
