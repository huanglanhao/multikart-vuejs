      ...
      <div class="setting_box_body">
        ...
        <div class="setting-body">
          ...
          <div class="setting-contant" :class="{ opensubmenu: isActive('color option') }">
            <ul class="color-box">
              <li :class="{ active : selectedColor('color1') }">
                <a href="javascript:void(0)" class="color1" @click="customizeThemeColor('color1')"></a>
              </li>
              <li :class="{ active : selectedColor('color2') }">
                <a href="javascript:void(0)" class="color2" @click="customizeThemeColor('color2')"></a>
              </li>
              <li :class="{ active : selectedColor('color3') }">
                <a href="javascript:void(0)" class="color3" @click="customizeThemeColor('color3')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color4" @click="customizeThemeColor('color4')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color5" @click="customizeThemeColor('color5')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color6" @click="customizeThemeColor('color6')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color7" @click="customizeThemeColor('color7')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color8" @click="customizeThemeColor('color8')"></a>
              </li>
              <li>
                <a href="javascript:void(0)" class="color9" @click="customizeThemeColor('color9')"></a>
              </li>
              <li>
                <a
                  href="javascript:void(0)"
                  class="color10"
                  @click="customizeThemeColor('color10')"
                ></a>
              </li>
              <li>
                <a
                  href="javascript:void(0)"
                  class="color11"
                  @click="customizeThemeColor('color11')"
                ></a>
              </li>
              <li>
                <a
                  href="javascript:void(0)"
                  class="color12"
                  @click="customizeThemeColor('color12')"
                ></a>
              </li>
              <li>
                <a
                  href="javascript:void(0)"
                  class="color13"
                  @click="customizeThemeColor('color13')"
                ></a>
              </li>
              <li>
                <a
                  href="javascript:void(0)"
                  class="color14"
                  @click="customizeThemeColor('color14')"
                ></a>
              </li>
              <li>
                <a
                  href="javascript:void(0)"
                  class="color15"
                  @click="customizeThemeColor('color15')"
                ></a>
              </li>
              <li>
                <a
                  href="javascript:void(0)"
                  class="color16"
                  @click="customizeThemeColor('color16')"
                ></a>
              </li>
              <li>
                <a
                  href="javascript:void(0)"
                  class="color17"
                  @click="customizeThemeColor('color17')"
                ></a>
              </li>
              <li>
                <a
                  href="javascript:void(0)"
                  class="color18"
                  @click="customizeThemeColor('color18')"
                ></a>
              </li>
            </ul>
          </div>
