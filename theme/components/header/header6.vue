                  ...
                  <ul class="header-dropdown">
                    <li class="mobile-wishlist">
                      <nuxt-link :to="{ path: '/page/account/wishlist' }">
                        <img :src='"@/assets/images/jewellery/icon/heart.png"' alt />
                      </nuxt-link>
                    </li>
                    <li class="onhover-dropdown mobile-account">
                      ...
                      <ul class="onhover-show-div">
                        <li>
                          <nuxt-link :to="{ path: '/page/account/login' }">登录</nuxt-link>
                        </li>
                        <li>
                          <nuxt-link :to="{ path: '/page/account/dashboard' }">仪表板</nuxt-link>
                        </li>
                      </ul>
                    </li>
                  </ul>
                  ...
                  <div class="icon-nav">
                    <ul>
                      <li class="onhover-div mobile-search">
                        <div>
                          <img :src='"@/assets/images/jewellery/icon/search.png"' @click="openSearch()"
                            class="img-fluid" alt />
                                    ...
                                    <form>
                                      <div class="form-group mb-0">
                                        <input type="text" class="form-control" v-model="searchString"
                                          @keyup="searchProduct" placeholder="Search a Product">
                                      </div>
                      ...
                      <li class="onhover-div mobile-setting">
                        <div>
                          <img :src='"@/assets/images/jewellery/icon/controls.png"' class="img-fluid" alt />
                      ...
                      <li class="onhover-div mobile-cart">
                        <div>
                          <img :src='"@/assets/images/jewellery/icon/cart.png"' class="img-fluid" alt="cart" />
